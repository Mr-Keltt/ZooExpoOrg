...
namespace ZooExpoOrg.Context.Migrations.PgSql.Migrations
{
    ...
    [Migration("20240314220539_ConfirmationAchievementChange")]
    partial class ConfirmationAchievementChange
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ZooExpoOrg.Context.Entities.Achievement", b =>
                {
                    ...
                    b.HasOne("ZooExpoOrg.Context.Entities.ConfirmationAchievement", "ConfirmationAchievement")
                        .WithOne("Achievement")
                        .HasForeignKey("ZooExpoOrg.Context.Entities.Achievement", "ConfirmationAchievementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ZooExpoOrg.Context.Entities.AnimalComment", b =>
                {
                    ...
                    b.HasOne("ZooExpoOrg.Context.Entities.Common.Comment", null)
                        .WithOne()
                        .HasForeignKey("ZooExpoOrg.Context.Entities.AnimalComment", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ZooExpoOrg.Context.Entities.ExpositionComment", b =>
                {
                    ...
                    b.HasOne("ZooExpoOrg.Context.Entities.Common.Comment", null)
                        .WithOne()
                        .HasForeignKey("ZooExpoOrg.Context.Entities.ExpositionComment", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
